...
<template>
  <div class="min-h-screen bg-slate-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 font-sans">
    <div class="absolute top-8 left-8">
      <NuxtLink to="/" class="flex items-center gap-2 text-slate-500 hover:text-indigo-600 transition-colors font-medium">
        <ArrowLeft :size="20" />
        Kembali ke Beranda
      </NuxtLink>
    </div>
    ...
    <div class="sm:mx-auto sm:w-full sm:max-w-md text-center">
      <div class="flex justify-center items-center gap-2 mb-6">
        <CheckCircle class="text-indigo-600" :size="40" />
        <span class="text-3xl font-bold tracking-tight text-slate-900">TaskFlow</span>
      </div>
      <h2 class="text-3xl font-extrabold text-slate-900">Selamat datang kembali</h2>
      <p class="mt-2 text-sm text-slate-600">Masuk untuk mengelola tugas dan tim Anda</p>
    </div>
    ...
    <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
      <div class="bg-white py-10 px-6 shadow-xl shadow-slate-200/50 sm:rounded-3xl border border-slate-100 sm:px-12">
        <form class="space-y-6" @submit.prevent="handleLogin">
          <div>
            ...
            <div class="mt-2 relative">
              ...
              <input
                ...
                class="block w-full pl-10 pr-3 py-3 border border-slate-200 rounded-xl leading-5 bg-slate-50 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              />
            </div>
          </div>
          ...
          <div>
            <div class="flex justify-between">
              ...
              <a href="#" class="text-sm font-medium text-indigo-600 hover:text-indigo-500">Lupa password?</a>
            </div>
            <div class="mt-2 relative">
              <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-slate-400">
                <Lock :size="18" />
        ...
        <div class="mt-8 grid grid-cols-2 gap-4">
          <button
            ...
            :disabled="isLoading"
            class="flex items-center justify-center gap-2 px-4 py-2.5 border border-slate-200 rounded-xl hover:bg-slate-50 transition-colors font-medium text-slate-700 text-sm disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-white"
          >
      ...
      <p class="mt-8 text-center text-xs text-slate-400">&copy; 2024 TaskFlow Inc. Keamanan data Anda adalah prioritas kami.</p>
    </div>
  </div>
</template>
